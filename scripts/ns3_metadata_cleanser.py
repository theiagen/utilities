...
output_headers = ['entity:cdc_specimen_03_id', 'collection_date', 'county', 'gisaid_accession', 'nextclade_clade', 'pango_lineage', 'sequencing_lab', 'state', 'zip']

# rename headers
meta_df1.rename(columns={'vendor_accession': 'entity:cdc_specimen_03_id', 'GISAID_accession': 'gisaid_accession', 'clade_Nextclade_clade': 'nextclade_clade', 'lineage_PANGO_lineage': 'pango_lineage', 'vendor': 'sequencing_lab'}, inplace=True)
...
meta_df1[['sample_name_part1','sample_name_part2']] = meta_df1['entity:cdc_specimen_03_id'].str.split('_L',expand=True)
meta_df1['entity:cdc_specimen_03_id'] = meta_df1['sample_name_part1']
